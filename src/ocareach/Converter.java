...
public class Converter {
	...
	public BoolExpr convertExpr(IntExpr sVar, IntExpr tVar) {
		...
		return this.convertExpr(oca.getInitState(), this.oca.getTargetState(), sVar, tVar);
	}
	...
	public BoolExpr convertExpr(State startState, State endState, IntExpr sVar, IntExpr tVar) {
		...
		result = (BoolExpr) resultExpr.simplify();
		return result;
	}
	...
	public BoolExpr equivDebug(IntExpr sVar, IntExpr tVar, BoolExpr tempResult) {
		...
		BoolExpr equiv = (BoolExpr) this.getQfpaGen().mkExistsQuantifier(bounds,
					this.getQfpaGen().mkAndBool(
							this.getQfpaGen().mkEqBool(tVar, this.getQfpaGen().mkSubInt(this.getQfpaGen().sumUpVars(sum), this.getQfpaGen().mkConstantInt(1))),
				...
				for(DGVertex ve : support.getVertices()) {
					...
					formGe = this.getQfpaGen().mkOrBool(
						...
						this.getQfpaGen().mkAndBool(
							...
							this.getQfpaGen().mkGeBool(midVar, this.getQfpaGen().mkConstantInt(support.getVertices().size()*this.getDgraph().getMaxAbsValue())),
							formGeDynamic
						)
					);
